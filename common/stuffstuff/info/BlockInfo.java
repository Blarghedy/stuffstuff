...
public class BlockInfo
{
	...
	public static final int PLAID_GRASS_DEFAULT = 400;
	...
	public static final int PLAID_LEAVES_DEFAULT = 401;
	...
	public static final int PLAID_SAND_DEFAULT = 402;
	...
	public static final int PLAID_GRAVEL_DEFAULT = 403;
	...
	public static final int PLAID_COBBLESTONE_DEFAULT = 404;
	...
	public static final int PLAID_STONE_DEFAULT = 405;
	...
	public static final int PLAID_DIRT_DEFAULT = 406;
	...
	public static final int PLAID_STONE_BRICK_DEFAULT = 407;
	...
	public static final int PLAID_GLASS_DEFAULT = 408;
	...
	public static final int FUN_FLUIX_DEFAULT = 409;
	...
	public static final int FLUIX_BRICK_DEFAULT = 410;
	...
	public static final int FLUIX_GLASS_DEFAULT = 411;
	...
	public static final int PLAID_STONE_STAIRS_DEFAULT = 412;
	...
	public static final int PLAID_COBBLESTONE_STAIRS_DEFAULT = 413;
	...
	public static final int PLAID_PLANK_STAIRS_DEFAULT = 414;
	...
	public static final int PLAID_STONE_BRICK_STAIRS_DEFAULT = 415;
	...
	public static final int PLAID_TALL_GRASS_DEFAULT = 416;
	...
	public static final int FLUIX_BRICK_STAIRS_DEFAULT = 417;
	...
	public static final int FINE_FLUIX_BRICK_STAIRS_DEFAULT = 418;
	...
	public static final int FUN_FLUIX_BRICK_STAIRS_DEFAULT = 419;
	...
	public static final int RUNNING_FLUIX_BRICK_STAIRS_DEFAULT = 420;
	...
	public static final int GREEN_PLAID_LOG_STAIRS_DEFAULT = 421;
	...
	public static final int RED_PLAID_LOG_STAIRS_DEFAULT = 422;
	...
	public static final int BLUE_PLAID_LOG_STAIRS_DEFAULT = 423;
	...
	public static final int WHITE_PLAID_LOG_STAIRS_DEFAULT = 424;
	...
	public static final int OAK_LOG_STAIRS_DEFAULT = 425;
	...
	public static final int SPRUCE_LOG_STAIRS_DEFAULT = 426;
	...
	public static final int BIRCH_LOG_STAIRS_DEFAULT = 427;
	...
	public static final int JUNGLE_LOG_STAIRS_DEFAULT = 428;
	...
	public static int WATER_STAIRS_ID;
	public static final int WATER_STAIRS_DEFAULT = 429;
	public static final String WATER_STAIRS_KEY = "waterStairs";
	public static final String WATER_STAIRS_NAME = "Water Stairs";
	public static final String WATER_STAIRS_UNLOCALIZED_NAME = "waterStairs";

	public static int LAVA_STAIRS_ID;
	public static final int LAVA_STAIRS_DEFAULT = 430;
	public static final String LAVA_STAIRS_KEY = "lavaStairs";
	public static final String LAVA_STAIRS_NAME = "Lava Stairs";
	public static final String LAVA_STAIRS_UNLOCALIZED_NAME = "lavaStairs";

	public static int IRON_ORE_STAIRS_ID;
	public static final int IRON_ORE_STAIRS_DEFAULT = 431;
	public static final String IRON_ORE_STAIRS_KEY = "ironOreStairs";
	public static final String IRON_ORE_STAIRS_NAME = "Iron Ore Stairs";
	public static final String IRON_ORE_STAIRS_UNLOCALIZED_NAME = "ironOreStairs";

	public static int SILVERFISH_STAIRS_ID;
	public static final int SILVERFISH_STAIRS_DEFAULT = 432;
	public static final String SILVERFISH_STAIRS_KEY = "silverfishStairs";
	public static final String SILVERFISH_STAIRS_NAME = "Silverfish Stairs";
	public static final String SILVERFISH_STAIRS_UNLOCALIZED_NAME = "silverfishStairs";

	public static int REDSTONE_STAIRS_ID;
	public static final int REDSTONE_STAIRS_DEFAULT = 433;
	public static final String REDSTONE_STAIRS_KEY = "redstoneStairs";
	public static final String REDSTONE_STAIRS_NAME = "Redstone Stairs";
	public static final String REDSTONE_STAIRS_UNLOCALIZED_NAME = "redstoneStairs";

	public static int STONE_SLAB_ID;
	public static int STONE_SLAB_DOUBLE_ID;
	public static final int STONE_SLAB_DEFAULT = 500;
	public static final int STONE_SLAB_DOUBLE_DEFAULT = 501;
	...
	public static final int WOOD_SLAB_DEFAULT = 502;
	public static final int WOOD_SLAB_DOUBLE_DEFAULT = 503;
	...
	public static final int FLUIX_SLAB_DEFAULT = 504;
	public static final int FLUIX_SLAB_DOUBLE_DEFAULT = 505;
	...
	public static final int LOG_SLAB_DEFAULT = 506;
	public static final int LOG_SLAB_DOUBLE_DEFAULT = 507;
	...
	public static int WATER_SLAB_ID;
	public static int WATER_SLAB_DOUBLE_ID;
	public static final int WATER_SLAB_DEFAULT = 508;
	public static final int WATER_SLAB_DOUBLE_DEFAULT = 509;
	public static final String WATER_SLAB_KEY = "waterSlab";
	public static final String WATER_SLAB_DOUBLE_KEY = "waterSlabDouble";
	public static final String WATER_SLAB_UNLOCALIZED_NAME = "waterSlab";
	public static final String WATER_SLAB_DOUBLE_UNLOCALIZED_NAME = "waterSlabDouble";

	public static int LAVA_SLAB_ID;
	public static int LAVA_SLAB_DOUBLE_ID;
	public static final int LAVA_SLAB_DEFAULT = 510;
	public static final int LAVA_SLAB_DOUBLE_DEFAULT = 511;
	public static final String LAVA_SLAB_KEY = "lavaSlab";
	public static final String LAVA_SLAB_DOUBLE_KEY = "lavaSlabDouble";
	public static final String LAVA_SLAB_UNLOCALIZED_NAME = "lavaSlab";
	public static final String LAVA_SLAB_DOUBLE_UNLOCALIZED_NAME = "lavaSlabDouble";

	public static int REDSTONE_SLAB_ID;
	public static int REDSTONE_SLAB_DOUBLE_ID;
	public static final int REDSTONE_SLAB_DEFAULT = 512;
	public static final int REDSTONE_SLAB_DOUBLE_DEFAULT = 513;
	public static final String REDSTONE_SLAB_KEY = "redstoneSlab";
	public static final String REDSTONE_SLAB_DOUBLE_KEY = "redstoneSlabDouble";
	public static final String REDSTONE_SLAB_UNLOCALIZED_NAME = "redstoneSlab";
	public static final String REDSTONE_SLAB_DOUBLE_UNLOCALIZED_NAME = "redstoneSlabDouble";

	public static int SILVERFISH_SLAB_ID;
	public static int SILVERFISH_SLAB_DOUBLE_ID;
	public static final int SILVERFISH_SLAB_DEFAULT = 514;
	public static final int SILVERFISH_SLAB_DOUBLE_DEFAULT = 515;
	public static final String SILVERFISH_SLAB_KEY = "silverfishSlab";
	public static final String SILVERFISH_SLAB_DOUBLE_KEY = "silverfishSlabDouble";
	public static final String SILVERFISH_SLAB_UNLOCALIZED_NAME = "silverfishSlab";
	public static final String SILVERFISH_SLAB_DOUBLE_UNLOCALIZED_NAME = "silverfishSlabDouble";
	...
	public static int WATER_DOOR_ID;
	public static final int WATER_DOOR_DEFAULT = 601;
	public static final String WATER_DOOR_KEY = "doorWater";
	public static final String WATER_DOOR_NAME = "Water Door";
	public static final String WATER_DOOR_UNLOCALIZED_NAME = "doorWater";

	public static int LAVA_DOOR_ID;
	public static final int LAVA_DOOR_DEFAULT = 602;
	public static final String LAVA_DOOR_KEY = "doorLava";
	public static final String LAVA_DOOR_NAME = "Lava Door";
	public static final String LAVA_DOOR_UNLOCALIZED_NAME = "doorLava";

	public static int IRON_ORE_DOOR_ID;
	public static final int IRON_ORE_DOOR_DEFAULT = 603;
	public static final String IRON_ORE_DOOR_KEY = "doorIronOre";
	public static final String IRON_ORE_DOOR_NAME = "Iron Ore Door";
	public static final String IRON_ORE_DOOR_UNLOCALIZED_NAME = "doorIronOre";

	public static int DIAMOND_DOOR_ID;
	public static final int DIAMOND_DOOR_DEFAULT = 604;
	public static final String DIAMOND_DOOR_KEY = "doorDiamond";
