...
//                    icon = this.getBlockIconFromSideAndMetadata(par1Block, 2, meta);
            ...
            if (renderer.renderAllFaces || flag1)
            {
                ...
                renderer.renderFaceYNeg(block, (double)x, (double)y + d6, (double)z, tmpIcon); //this.getBlockIconFromSide(par1Block, 0));
                flag2 = true;
            }
...
//                Icon icon1 = this.getBlockIconFromSideAndMetadata(par1Block, j1 + 2, meta);
                ...
                if (renderer.renderAllFaces || aboolean[j1])
                {
                    ...
                    tessellator.addVertexWithUV(d16, (double)y + d15, d19, (double)f12, (double)f8);
                    tessellator.addVertexWithUV(d18, (double)y + d17, d20, (double)f9, (double)f7);
                    tessellator.addVertexWithUV(d18, (double)(y + 0), d20, (double)f9, (double)f13);
                    tessellator.addVertexWithUV(d16, (double)(y + 0), d19, (double)f12, (double)f13);
                }
            }
