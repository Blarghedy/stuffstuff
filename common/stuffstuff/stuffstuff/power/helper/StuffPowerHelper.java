package stuffstuff.stuffstuff.power.helper;
...
public class StuffPowerHelper
{
	 ...
	 * 
	 * @param itemstack
	 *            {@link ItemStack} whose item must implement {@link IStuffPower}
	...
	private static double getMaxStuffPower(ItemStack itemstack)
	{
		...
		if (itemstack == null)
			return 0;
		else if (itemstack.getItem() instanceof IStuffPower)
		{
			item = (IStuffPower)itemstack.getItem();
		}
		else
			return 0;
	...
	public double getStuffPowerPercent(ItemStack itemstack)
	{
		...
		if (max == 0)
			...
			return getStuffPower(itemstack) / max;
	}
